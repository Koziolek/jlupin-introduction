...
SET LOG_FILE_PATH=%JLUPIN_HOME%\%WINDOWS_SERVER_OUT%

icacls.exe %JLUPIN_HOME%\ /grant "NT AUTHORITY\LocalService":(OI)(CI)F /T /Q
%JLUPIN_HOME%\start\control\bin\JLupinPlatformService.exe -install -serviceName %SERVICE_NAME% -platformPath %JLUPIN_HOME%\ -logFilePath %LOG_FILE_PATH%
