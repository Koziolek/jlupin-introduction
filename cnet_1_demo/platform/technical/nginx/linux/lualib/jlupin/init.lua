...
function JLupinInitStartDiscoveryTimer()
  ...
  local ok, err = ngx.timer.at(1, CoreNginxDiscoveryTimer)
  ...
  local ok, err = ngx.timer.at(2, CoreDiscoveryTimer)
...
function JLupinInitStartBalancerTimer()
  ...
  local ok, err = ngx.timer.at(3, CoreBalancerTimer)
  ...
  then
    ...
    then
        ...
        then
          ...
          ngx.header['Set-Cookie'] = jlebCookie .. '=' .. jlebCookieValue .. balancerCookieOptions
        end
    end
